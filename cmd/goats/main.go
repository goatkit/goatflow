...
func main() {
	...
	apiHandlers := map[string]gin.HandlerFunc{
		...
		"HandleListSystemAddressesAPI": api.HandleListSystemAddressesAPI,
		"HandleCreateSystemAddressAPI": api.HandleCreateSystemAddressAPI,
		"HandleUpdateSystemAddressAPI": api.HandleUpdateSystemAddressAPI,
		...
		"HandleListSalutationsAPI":     api.HandleListSalutationsAPI,
		"HandleCreateSalutationAPI":    api.HandleCreateSalutationAPI,
		"HandleUpdateSalutationAPI":    api.HandleUpdateSalutationAPI,
		"HandleListSignaturesAPI":      api.HandleListSignaturesAPI,
		"HandleCreateSignatureAPI":     api.HandleCreateSignatureAPI,
		"HandleUpdateSignatureAPI":     api.HandleUpdateSignatureAPI,
		...
		"handleAdminEmailIdentities":    api.HandleAdminEmailIdentities,
		...
		"handleAdminServiceCreate":                 api.HandleAdminServiceCreate,
		"handleAdminServiceUpdate":                 api.HandleAdminServiceUpdate,
		"handleAdminServiceDelete":                 api.HandleAdminServiceDelete,
		"handleAdminSLA":                            api.HandleAdminSLA,
		"handleAdminSLACreate":                      api.HandleAdminSLACreate,
		"handleAdminSLAUpdate":                      api.HandleAdminSLAUpdate,
		"handleAdminSLADelete":                      api.HandleAdminSLADelete,
		"handleAdminRoles":                          api.HandleAdminRoles,
		"handleAdminRoleCreate":                     api.HandleAdminRoleCreate,
		"handleAdminRoleGet":                        api.HandleAdminRoleGet,
		"handleAdminRoleUpdate":                     api.HandleAdminRoleUpdate,
		"handleAdminRoleDelete":                     api.HandleAdminRoleDelete,
		"handleAdminRoleUsers":                      api.HandleAdminRoleUsers,
		"handleAdminRoleUserAdd":                    api.HandleAdminRoleUserAdd,
		"handleAdminRoleUserRemove":                 api.HandleAdminRoleUserRemove,
		"handleAdminRolePermissions":                api.HandleAdminRolePermissions,
		"handleAdminRolePermissionsUpdate":          api.HandleAdminRolePermissionsUpdate,
