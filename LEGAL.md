# Legal Notice and Compatibility Statement
...
### What We DON'T Do:
- We do NOT copy source code from OTRS or any other ticketing system
- We do NOT use proprietary algorithms or business logic from other systems
- We do NOT claim affiliation with or endorsement from OTRS AG
- We do NOT use trademarked names except for compatibility descriptions

## Compatibility Rationale

Database schema compatibility is maintained solely for the purpose of:
1. Enabling data migration for users transitioning between systems
2. Allowing third-party tools to work with multiple ticketing systems
3. Following established industry patterns for ticket management

This is similar to how:
- LibreOffice maintains file format compatibility with Microsoft Office
- Wine implements Windows APIs for Linux
- MariaDB maintains compatibility with MySQL
...
2. Not copy code from other projects
3. Follow clean-room implementation practices
