    ...
    "paths": {
        "/api/v1/admin/sql": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SQL query and optional arguments",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.adminSQLRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Login credentials (login, password)",
                        "name": "credentials",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "JWT tokens (access_token, refresh_token)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/mcp/sse": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "MCP Session ID (required after initialize)",
                        "name": "Mcp-Session-Id",
                        "in": "header"
                    },
                    {
        ...
        "/queues": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Queue data (name, group_id, etc.)",
                        "name": "queue",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/queues/{id}/details": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Queue details with stats",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/salutations": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of salutations",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created salutation",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/salutations/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Salutation update data",
                        "name": "salutation",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/search/health": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Search health status",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/services": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by validity (1=valid, 2=invalid, all)",
                        "name": "valid",
                        "in": "query"
                    }
                ],
        ...
        "/signatures/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Signature update data",
                        "name": "signature",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/system-addresses": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of system addresses",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "System address data",
                        "name": "address",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/tickets": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 20,
                        "description": "Alias for per_page (max 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter by customer user ID/login",
                    ...
                    {
                        "type": "string",
                        "description": "Search in ticket number, title, customer",
                        "name": "search",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Include related data (comma-separated: article_count, last_article)",
                        "name": "include",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ticket data (title, queue_id, priority_id, customer_user_id, article)",
                        "name": "ticket",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/tickets/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Include related data (comma-separated: articles, customer, queue)",
                        "name": "include",
                        "in": "query"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Ticket update data (title, queue_id, priority_id, state_id, etc.)",
                        "name": "ticket",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/tickets/{id}/assign": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Assignment data (user_id)",
                        "name": "assign",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/tickets/{id}/close": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Close data (state_id, note)",
                        "name": "close",
                        "in": "body",
                        "schema": {
                            "type": "object"
        ...
        "/tickets/{ticket_id}/articles": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Article data (body, subject, article_type, sender_type, etc.)",
                        "name": "article",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/tokens": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Token data (name, scopes, expires_at)",
                        "name": "token",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created token (includes raw token - save it!)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search in login, name, email",
                        "name": "search",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User data (login, email, first_name, last_name, password)",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
