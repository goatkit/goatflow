...
func (m *mockHostAPI) ListTicketViews(ctx context.Context) ([]plugin.TicketViewInfo, error) {
	return nil, fmt.Errorf("not implemented")
}
...
func (m *trackingHostAPI) ListTicketViews(ctx context.Context) ([]plugin.TicketViewInfo, error) {
	return nil, fmt.Errorf("not implemented")
}
...
func (m *trackingHostAPI) GetFile(ctx context.Context, key string) ([]byte, map[string]string, error) {
	return nil, nil, nil
}
