...
func (m *mockHostAPIForTag) EntitySoftDelete(ctx context.Context, entityType string, entityID int64, reason string) error {
	return nil
}

func (m *mockHostAPIForTag) EntityRestore(ctx context.Context, entityType string, entityID int64) error {
	return nil
}

func (m *mockHostAPIForTag) EntityHardDelete(ctx context.Context, entityType string, entityID int64, reason string) error {
	return nil
}

func (m *mockHostAPIForTag) RecycleBinList(ctx context.Context, entityType string) (json.RawMessage, error) {
	return nil, nil
}
...
func (m *mockHostAPIForTag) GetFile(ctx context.Context, key string) ([]byte, map[string]string, error) {
	return nil, nil, nil
}
func (m *mockHostAPIForTag) DeleteFile(ctx context.Context, key string) error { return nil }
func (m *mockHostAPIForTag) ListFiles(ctx context.Context, prefix string) ([]FileInfo, error) {
	return nil, nil
}

func (m *mockHostAPIForTag) GenerateThumbnail(_ context.Context, _ []byte, _ string, _, _ int) ([]byte, string, error) {
	return nil, "", fmt.Errorf("not implemented")
}
